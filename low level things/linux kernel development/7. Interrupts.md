...
**Interrupt Context**: non ha contesto, dunque non si possono usare istruzioni stile `sleep`.  Esegue in un contesto dove altro codice e' stato interrotto, dunque deve essere veloce!

**Interrupt Stack**: ogni cpu ha il suo stack per gestire tutti gli interrupt, e questo e' un'area di memoria fissata.

**Architettura**: gli handler dipendono fortemente dall'architettura del pc.